...
{
  Product* ret = new Book(prodName_, price_, qty_, isbn_, author_);
  return ret;
}
...
{
  Product* ret = new Clothing(prodName_, price_, qty_, size_, brand_);
  return ret;
...
{
  Product* ret = new Movie(prodName_, price_, qty_, genre_, rating_);
  return ret;
