...
{
  Book* ret = new Book(prodName_, price_, qty_, isbn_, author_);
  return ret;
}
...
{
  Clothing* ret = new Clothing(prodName_, price_, qty_, size_, brand_);
  return ret;
...
{
  Movie* ret = new Movie(prodName_, price_, qty_, genre_, rating_);
  return ret;
